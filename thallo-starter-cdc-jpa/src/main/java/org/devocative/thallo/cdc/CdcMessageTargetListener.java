...
public class CdcMessageTargetListener {
	...
	private final CdcEventService eventService;
	...
	public CdcMessageTargetListener(EntityManager entityManager, CdcConfiguration configuration, CdcEventService eventService) {
